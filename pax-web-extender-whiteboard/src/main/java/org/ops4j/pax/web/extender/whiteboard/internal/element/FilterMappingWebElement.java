...
/**
 * FIXME not sure if we need to track FilterMappings in addition to Filters
...
public class FilterMappingWebElement extends WebElement<FilterMapping> implements WhiteboardFilter {
	...
	/**
	 * Constructs a new FilterMappingWebElement
	 ...
	 */
	public FilterMappingWebElement(ServiceReference<FilterMapping> ref, final FilterMapping filterMapping) {
		super(ref);
